...
public class UpdateOrder extends javax.swing.JPanel {
    ...
    private void jbtUpdateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jbtUpdateActionPerformed
        ...
        else
        {
            ...
            {
                if(jcbOrder.getSelectedItem().toString().equals(orderManagement.getCustorder().getEntry(i).getOrderID().toString()+ " || " +orderManagement.getCustorder().getEntry(i).getCustName().toString())){
