...
public class UpdateDelivery extends javax.swing.JPanel {
    ...
    private void jbtUpdateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jbtUpdateActionPerformed
        ...
        else
        {
            ...
            {
                if(jcbDelivery.getSelectedItem().toString().equals(orderManagement.getCustDelivery().getEntry(i).getOrder_id() + " || " +orderManagement.getCustDelivery().getEntry(i).getCustomer().getCustName())){
    ...
    private void getDelivery(){
        ...
        while(orderManagement.getDeliveryQueue().isEmpty() != true ){
            ...
            if(delivery.getPickUpType().toString().equals("Delivery (+ RM 10)") || delivery.getPickUpType().toString().equals("Delivery")){
                    jcbDelivery.addItem(delivery.getOrder_id() + " || " +delivery.getCustomer().getCustName());
            }
        }    
    }
